...
const checkToken = [check('password', 'The password must be at least 6 characters').isLength({ min: 6 }).toLowerCase(), validateErrors];

export { register, login, forgetPassword, checkToken };
